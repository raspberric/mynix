...
return {
  setup = function()
    vim.keymap.set("n", "<leader>cp", function() vim.cmd(":CccPick") end, { desc = "Open css color picker" })
    vim.keymap.set("n", "<leader>cc", function() vim.cmd(":CccConvert") end, { desc = "Convert css color" })
